...
def extract_features(tokens) :
   ...
   for k in range(0,len(tokens)):
      ...
      ### FOR THE FEATURE OF TOKEN AT INDEX I ###
      ...
      if k > 0:   # for the features that consider the previous word to extract the feature at the actual index
         ...
         tokenFeatures.append("firstLast="+tPrev[-1:]+t[0])
      else: 
         tokenFeatures.append("mid4=##"+t[:2])
      
      ### FOR THE FEATURE OF TOKEN AT INDEX I-1, THE PREVIOUS TOKEN ###

      if k>0 :   # for the previous token
         tPrev = tokens[k-1][0]
      ...
      if k - 1 > 0:
         ...
         tokenFeatures.append("firstLastPrev="+tPrev2[-1:]+tPrev[0])
      else:
         tokenFeatures.append("BoS")

      ### FOR THE FEATURE OF TOKEN AT INDEX I+1, THE NEXT TOKEN ###
      ...
      if k<len(tokens)-1 :
         ...
         tokenFeatures.append("firstLastNext="+t[-1:]+tNext[0])
      else:
